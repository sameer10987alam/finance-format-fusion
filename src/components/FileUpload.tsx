...
const FileUpload: React.FC<FileUploadProps> = ({
  ...
  return <div className={`relative rounded-lg border-2 border-dashed p-12 transition-all
      ...
      <div className="flex flex-col items-center justify-center space-y-4">
        <UploadCloud className="h-12 w-12 text-muted-foreground bg-gray-950 rounded-xl" />
      ...
      {isProcessing && <div className="absolute inset-0 flex items-center justify-center bg-background/50 rounded-lg">
